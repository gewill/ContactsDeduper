...
export const copy = {
  en: {
    ...
    whatItDoesText: "Finds duplicate contacts, including same name, phone, email, and more. You review each group and decide what to merge.",
    careful: "Built for careful cleanup", carefulText: "Preview every duplicate set before merging. Choose which details to keep, and see the result before you confirm.",
    backup: "Backup and restore", backupText: "Create a full backup of your contacts before you make changes. Restore anytime if you need to.",
    questions: "Questions & answers", faq: [
      ["Does ContactsDeduper upload my contacts?", "No. Your contacts are processed locally and are never uploaded to us."],
      ["Is it safe to merge contacts?", "You can preview every duplicate set and choose exactly what to keep. Export a backup before changes."],
      ["Can I restore my contacts?", "Yes. Restore from a backup you created with ContactsDeduper."],
      ["Which devices and versions are supported?", "ContactsDeduper supports iOS 17 or later and native macOS 14 or later."]
    ],
    feedback: "For help, use GitHub Issues. Do not attach real contact data or backup files.",
...
Object.assign(copy.ko, { support: "지원", privacy: "개인정보 보호", switchLanguage: "언어", home: "홈", title: "연락처는 기기에 남아 있습니다.", intro: "ContactsDeduper는 iPhone 또는 Mac에서 중복 연락처를 찾아 확인한 뒤 안전하게 병합합니다. 변경 전에 백업을 만들고 언제든 복원할 수 있습니다.", getSupport: "지원 받기", readPrivacy: "개인정보 처리방침", whatItDoes: "주요 기능", whatItDoesText: "이름, 전화번호, 이메일 등 중복 연락처를 찾습니다. 각 그룹을 검토하고 병합할 항목을 선택하세요.", careful: "신중한 정리를 위해", carefulText: "병합 전에 중복 그룹을 미리 보고 유지할 정보를 선택한 뒤 결과를 확인할 수 있습니다.", backup: "백업 및 복원", backupText: "변경 전에 연락처 전체를 백업하세요. 필요할 때 언제든 복원할 수 있습니다.", questions: "자주 묻는 질문", faq: [["연락처가 업로드되나요?", "아니요. 연락처는 기기에서 처리되며 어디에도 업로드되지 않습니다."], ["연락처 병합은 안전한가요?", "모든 중복 그룹을 미리 보고 유지할 내용을 선택할 수 있습니다. 변경 전에 백업하세요."], ["연락처를 복원할 수 있나요?", "예. ContactsDeduper에서 만든 백업으로 복원할 수 있습니다."], ["지원하는 OS는 무엇인가요?", "iOS 17 이상 및 네이티브 macOS 14 이상을 지원합니다."]], feedback: "도움이 필요하면 GitHub Issues를 이용하세요. 실제 연락처 데이터나 백업 파일을 첨부하지 마세요.", github: "GitHub", updated: "최근 업데이트" });
