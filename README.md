...
- 完整国际格式（`+国家码`）适用于所有国家和地区；本地格式转换目前支持美国、加拿大、中国大陆、英国、德国、日本、中国台湾、中国香港、中国澳门、新加坡、澳大利亚、法国、西班牙、意大利和印度。可在首页手动选择本地号码的默认地区；联系人地址中明确的国家或地区仍会优先使用。其他地区缺少地区信息的本地号码可能无法与国际格式自动匹配。
